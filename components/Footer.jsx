          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="mt-6 flex flex-col gap-2">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full border border-bg-borderHi bg-bg-elevated/60 px-4 py-2 text-sm text-ink transition-all hover:border-[#25D366]/40 hover:bg-[#25D366]/5"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full border border-bg-borderHi bg-bg-elevated/60 px-4 py-2 text-sm text-ink transition-all hover:border-cyan-glow/30 hover:bg-cyan-glow/5"
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="text-cyan-glow" aria-hidden>
